...
!(function () {
    ...
    function L(t) {
      ...
      return { resources: e, path: t.path || "/", maxURL: t.maxURL || 500, rotate: t.rotate || 750, timeout: t.timeout || 5e3, random: !0 === t.random, index: t.index || 0, dataAfterTimeout: !1 !== t.dataAfterTimeout };
    }
    ...
    function Lt(t, e) {
      ...
      if ("svg" === s)
        c = (function (t) {
          ...
          return (e.innerHTML = Mt(t.body, t.attributes)), e.firstChild;
        })(r);
      else
        c = (function (t, e, n) {
          ...
          const r = t.attributes,
            s =
              ...
              ((u = Mt(i, { ...r, width: e.width + "", height: e.height + "" })), u.replace(/"/g, "'").replace(/%/g, "%25").replace(/#/g, "%23").replace(/</g, "%3C").replace(/>/g, "%3E").replace(/\s+/g, " ") + '")'),
            c = o.style,
